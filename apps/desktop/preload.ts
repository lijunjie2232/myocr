...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  db: {
    ...
    // OCR Tasks
    createOcrTask: (task: unknown) => ipcRenderer.invoke('db:createOcrTask', task),
    updateOcrTask: (id: string, updates: unknown) => ipcRenderer.invoke('db:updateOcrTask', id, updates),
    ...
    // Summary Tasks
    createSummaryTask: (task: unknown) => ipcRenderer.invoke('db:createSummaryTask', task),
    updateSummaryTask: (id: string, updates: unknown) => ipcRenderer.invoke('db:updateSummaryTask', id, updates),
    ...
    // Prompt Templates
    createPrompt: (task: unknown) => ipcRenderer.invoke('db:createPrompt', task),
    ...
    updatePrompt: (id: string, updates: unknown) => ipcRenderer.invoke('db:updatePrompt', id, updates),
  },
  
  // OCR Service
  ocr: {
    processImage: (request: unknown) => ipcRenderer.invoke('ocr:processImage', request),
    setApiInstances: (configs: unknown[]) => ipcRenderer.invoke('ocr:setApiInstances', configs),
  },
  
  // Summary Service
  summary: {
    processSummary: (request: unknown) => ipcRenderer.invoke('summary:processSummary', request),
    setApiInstances: (configs: unknown[]) => ipcRenderer.invoke('summary:setApiInstances', configs),
  },
});
